...
```{r}
### EXPLORE HERE ###
glimpse(apt_buildings) #too many columns
glimpse(building_permits) #looks good
glimpse(cancer_sample) #too many columns
glimpse(flow_sample) #columns have easy names
glimpse(parking_meters) #confusing column names
glimpse(steam_games) #straightforward data
glimpse(vancouver_trees) #straightforward data as well
```
