...
Alternatively, we can combine 'civic_number' and 'std_street' to retrieve the full address and form a new variable. In that case, it would be good to also combine 'on_street_block' and 'on_street' to form another new variable to capture the full information.  

It wonder if it would be worthwhile to combine 'latitude' and 'longitude' and call this variable 'coordinates' with latitude as the first number.
<!----------------------------------------------------------------------------->
...
**Tidying the data**
```{r} 
#At first I was confused why 'std_street' and 'on_street' were variables in the original data but rather than simplifying these two variables together, I will combine these variables with 'civic_number' and 'on_street_block' respectively.
vancouver_trees_tidy <- vancouver_trees %>%
  ...
  unite(col = coordinates, c(latitude, longitude), sep = ",") %>%
  print(n=5)

glimpse(vancouver_trees_tidy)
